...
try {
	...
	const response = await fetch(`https://api.yelp.com/v3/businesses/search?location=${req.query.location}&price=${req.query.price}&categories=${req.query.category}&radius=${req.query.radius}&limit=50`, {
		method: 'GET',
		headers: {
